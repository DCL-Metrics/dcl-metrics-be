      ...
      base_attributes.merge(
        {
          ...
          grants_authored_count: dao_activity.grants_authored_count || 0,
          grants_beneficiary_count: dao_activity.grants_beneficiary_count || 0,
          grants_data: dao_activity.grants,
          proposals_count: dao_activity.proposals_count || 0,
