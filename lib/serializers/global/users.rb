  ...
  module Global
    class Users
      ...
      def call
        ...
        @top_time_afk_yesterday = calculate_top(:time_spent_afk, :yesterday)
        ...
        @top_time_afk_last_week = calculate_top(:time_spent_afk, :last_week)
        ...
        @top_time_afk_last_month = calculate_top(:time_spent_afk, :last_month)
        ...
        @top_time_afk_last_quarter = calculate_top(:time_spent_afk, :last_quarter)

        {
          yesterday: {
            ...
            time_spent_afk: enrich_user_data(@top_time_afk_yesterday)
          },
          last_week: {
            ...
            time_spent_afk: enrich_user_data(@top_time_afk_last_week)
          },
          last_month: {
            ...
            time_spent_afk: enrich_user_data(@top_time_afk_last_month)
          },
          last_quarter: {
            ...
            time_spent_afk: enrich_user_data(@top_time_afk_last_quarter)
          }
        }
      end
